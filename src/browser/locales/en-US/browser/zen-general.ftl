...
zen-window-sync-migration-dialog-message = Epoca now syncs windows on the same device, so changes in one window are reflected across the others instantly.
